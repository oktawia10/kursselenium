...
public class Zadanie12a {
    ...
    public void TestKatalonForm() {
        ...
        Assert.assertNotNull(genders.get(1));
        ...
        Assert.assertNotNull(dataUrodzenia);
        ...
        Assert.assertNotNull(adressElement);
        ...
        Assert.assertNotNull(emailElement);
        ...
        Assert.assertNotNull(companyElement);
        ...
        Assert.assertNotNull(commentTextArea);
